...
void ten_face_current (	unsigned int rO, unsigned int zO, // old cell indices
  ...
  double  sigr, sigz,          // quantity to distignuish
      ...
      if ( rP0 + Dr > 0.5 ) {							    // UPWARDS MOVE
        ...
        iprintf(">> ten face move: no upwards/"
                "downwards move, acutally seven"
                " four face ?!\n");
        seven_face_current ( rO, zO, qu, Dr,
                             Dz, rP0, zP0 );
        return;
      }
      ...
      iiiprintf ( ">> ten face move: FIRST R, "
                  "THEN Z; sigr=%g, sigz=%g, "
                  "Dr1=%g, Dz1=%g, rP1=%g, zP1=%g, "
                  "prefix=%g, Dr2=%g, Dz2=%g, rP2=%g,"
                  " zP2=%g, Dr2=%g, Dz2=%g,"
                  " Dr3=%g, Dz3=%g\n",
                  sigr, sigz, Dr1, Dz1, rP1, zP1,
                  prefix, Dr2, Dz2, rP2, zP2, Dr2,
                  Dz2, Dr3, Dz3 );
      ...
      if ( zP0 + Dz > 0.5 ) {							    // UPWARDS MOVE
        ...
        iiprintf(">> ten face move: no upwards/"
                 "downwards move, acutally "
                 "seven face ?!\n");
        seven_face_current ( rO, zO, qu, Dr,
                             Dz, rP0, zP0 );
        return;
      ...
      if ( rP0 + Dr > 0.5 ) {                 // LEFT HAND MOVE
        ...
        iiprintf(">> ten face move: no left hand/"
                 "right hand move, acutally seven face ?!\n");
        seven_face_current ( rO, zO, qu, Dr,
                             Dz, rP0, zP0 );
        return;
      }
      ...
      iiiprintf ( ">> ten face move: FIRST Z, THEN R; "
                  "sigr=%g, sigz=%g, Dr1=%g,"
                  " Dz1=%g, rP1=%g, zP1=%g, prefix=%g, Dr2=%g,"
                  " Dz2=%g, rP2=%g, zP2=%g, Dr2=%g, Dz2=%g,"
                  " Dr3=%g, Dz3=%g\n",
                  sigr, sigz, Dr1, Dz1, rP1, zP1, prefix, Dr2,
                  Dz2, rP2, zP2, Dr2, Dz2, Dr3, Dz3 );

  } else {
    waprintf( ">> ten face move: can not distignuish between"
              " step queue; discarding ... data: zP0+(Dz/Dr)"
              "*sigr=%g, rP0+(Dr/Dz)*sigz=%g, sigr=%g, sigz=%g\n",
              zP0+(Dz/Dr)*sigr, rP0+(Dr/Dz)*sigz, sigr, sigz );
    return;
  }

	// REAL FIRST STEP
	iiiprintf(">> ten face first step: Dr1=%g, "
            "Dz1=%g, rP0=%g, zP0=%g, rO=%d, zO=%d\n",
	...
	iiiprintf(">> ten face second step: rO=%d, zO=%d, r2=%g, Dz2=%g"
            ...
            rO, zO, Dr2, Dz2, rP1, zP1,
            (int)(rO+rP0+Dr1), (int)(zO+zP0+Dz1));
  ...
  iiiprintf(">> ten face third step: Dr3=%g, Dz3=%g"
            ...
            Dr3, Dz3, rP2, zP2,
            (int)(rO+rP0+Dr2+Dr1), (int)(zO+zP0+Dz2+Dz1));
