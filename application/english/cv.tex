...
%
	...
	\cventry{10/2012--~now}{Masters~Degree~in~Physics}{Ernst-Moritz-Arndt~University}%
					{Greifswald}{Master~of~Sciences}{(Certificate~and~course~overview~included)}
	...
	\vspace*{0.5cm}
	\begin{center}
		% \fbox{\includegraphics[height=0.9\textheight]{fig_pdf/abitur_zeugnis.pdf}}	
	\end{center}
	...
	\vspace*{0.5cm}
	\begin{center}
		% \fbox{\includegraphics[height=0.9\textheight]{fig_pdf/bachelor_zeugnis.pdf}}	
	\end{center}
