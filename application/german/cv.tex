...
\begin{document}
	...
	\begin{minipage}{\textwidth}
		...
		\familynamestyle{\@firstname}~\firstnamestyle{\@familyname} 	
			\hspace*{5mm}%
			{{\color{firstnamecolor}\includegraphics[width=96pt]{fig_pdf/12.jpg}}}\\[0.3cm]
			\@addressstreet\\[0.0cm]%
			\@addresscity\\[0.3cm]%
...
%
	...
	\cventry{08/2010--06/2012}{Academic~High~School}{Schlossgymnasium Gützkow\newline~Gützkow}{}%
					{Higher~Education~Entrance~Qualification}{(Certificate~included)} 
	...
	\vspace*{0.0cm}
	\begin{center}
		\fbox{\includegraphics[height=0.9\textheight]{fig_pdf/zeugnis_gym1.pdf}}	
		\fbox{\includegraphics[height=0.9\textheight]{fig_pdf/zeugnis_gym2.pdf}}	
		\fbox{\includegraphics[height=0.9\textheight]{fig_pdf/zeugnis_gym3.pdf}}	
		\fbox{\includegraphics[height=0.9\textheight]{fig_pdf/zeugnis_gym4.pdf}}	
	\end{center}
	...
	\vspace*{0.0cm}
	\begin{center}
		\fbox{\includegraphics[height=0.9\textheight]{fig_pdf/zeugnis_bachelor_eng1.pdf}}	
		\fbox{\includegraphics[height=0.9\textheight]{fig_pdf/zeugnis_bachelor_eng2.pdf}}	
		\fbox{\includegraphics[height=0.9\textheight]{fig_pdf/zeugnis_bachelor_eng3.pdf}}	
		\fbox{\includegraphics[height=0.9\textheight]{fig_pdf/zeugnis_bachelor_eng4.pdf}}	
				 \fbox{\includegraphics[width=\textwidth]{fig_pdf/zeugnis_bachelor_eng5.pdf}}	
				 \fbox{\includegraphics[width=\textwidth]{fig_pdf/zeugnis_bachelor_eng6.pdf}}	
		\fbox{\includegraphics[height=0.9\textheight]{fig_pdf/zeugnis_bachelor_eng7.pdf}}	
		\fbox{\includegraphics[height=0.9\textheight]{fig_pdf/zeugnis_bachelor_eng8.pdf}}	
	\end{center}
	...
	\vspace*{0.0cm}
	\begin{center}
		\fbox{\includegraphics[page=1,height=0.9\textheight]{fig_pdf/notenspiegel_eng_master.pdf}}	
		\fbox{\includegraphics[page=2,height=0.9\textheight]{fig_pdf/notenspiegel_eng_master.pdf}}	
	\end{center}
