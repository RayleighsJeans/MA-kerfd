...
%
				...
				Works of, e.g.\@~\cite{Ustaze97} and~\cite{Los90} investigated ion beam scattering, electron loss and transport for metal walls, especially $\text{MgO}(100)$ surfaces. There Ustaze et al.\ studied incident oxygen gas particles --- ions and neutrals ---  on magnesium oxyde surfaces. Impinging atoms become a negatively charged ion, picking up an electron from the wall. This interaction, though requiring a minimum ionization or liberation energy for the electron, is resonant at low energies $<\unit[1]{eV}\,$.
%
